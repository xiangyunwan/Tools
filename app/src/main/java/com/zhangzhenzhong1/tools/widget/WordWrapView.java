 ...
 *
 * 标签自动换行
 * Created by zhangzhenzhong1 on 2016/3/2.
 */
public class WordWrapView extends ViewGroup {
    private static final int PADDING_HOR = 10;//水平方向padding
    private static final int PADDING_VERTICAL = 14;//垂直方向padding
    ...
    public WordWrapView(Context context) {
        super(context);
        SIDE_MARGIN= DisplayUtil.dipToPx(context,10);
        TEXT_MARGIN= DisplayUtil.dipToPx(context,3);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for(int i=0;i<childCount;i++){
            ...
            view.setBackgroundResource(R.drawable.newfeibiao_autowraptext_bg);
