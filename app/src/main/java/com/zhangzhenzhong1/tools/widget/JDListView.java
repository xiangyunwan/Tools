...
/**
 * 带有header和footer功能的listview
 */
@SuppressLint("SimpleDateFormat")
public class JDListView extends ListView implements OnScrollListener {
...
//	private TextView mHeaderTimeView;
	...
	public JDListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public JDListView(Context context, AttributeSet attrs, int defStyle) {
