 ...
 */
public class AutoScaleTextFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_auto_scale_text, container, false);
        }
        initView(rootView);
        return rootView;
    }
